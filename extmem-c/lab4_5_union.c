...
// lab4_5_union.c 一遍扫描创建的有序单组会临时存放在1401开始的磁盘块
// lab4_5_union.c 二遍扫描存储连接结果存放在从601开始的磁盘块
static int temp_block_no = 1401;
static int output_blk_no = 601;
